...
title: IMU Comparison
---

# IMU Comparison {#imu-comparison}
...
## What's the difference between an IMU with a magnetometer (9 DOF) and an IMU without a magnetometer (6 DOF)? {#whats-the-difference-between-an-imu-with-a-magnetometer-9-dof-and-an-imu-without-a-magnetometer-6-dof}
...
## How can I check if I have an acceptable magnetic environment? {#how-can-i-check-if-i-have-an-acceptable-magnetic-environment}
...
## My app show around X uT is that okay? {#my-app-show-around-x-ut-is-that-okay}
...
## What determines a "poor magnetic environment"? {#what-determines-a-poor-magnetic-environment}
...
## Does magnetic interference cause drift? {#does-magnetic-interference-cause-drift}
...
## Can I still use my IMU with a magnetometer if I don't have a stable magnetic environment? {#can-i-still-use-my-imu-with-a-magnetometer-if-i-dont-have-a-stable-magnetic-environment}
