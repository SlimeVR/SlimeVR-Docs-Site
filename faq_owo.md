...
The application uses SlimeVR Server for tracking. To set up SlimeVR Server, refer to [SlimeVR setup guide](slimevr_setup.md).
...
​For more information, refer to [SlimeVR setup guide](slimevr_setup.md).
...
To learn how to set up tracker roles, refer to [SlimeVR setup guide](slimevr_setup.md).
