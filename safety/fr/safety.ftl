...
title = FR: Instructions pour une utilisation sécuritaire

warning_list = Pour prévenir des dommages ou des dysfonctionnements et assurer une utilisation appropriée du produit, veuillez observer les précautions suivantes:
warning_list-water = N’exposez pas le produit à l’eau ou à l’humidité.
...
warning_battery = Le produit contient une batterie au lithium. Une manipulation inappropriée d’une batterie au lithium peut provoquer une détérioration ou un dysfonctionnement de l’appareil, ce qui, dans des cas extrêmes, peut présenter un risque de dégagement de chaleur, un risque d’émission de fumées ou de gaz ainsi qu’un risque d’incendie et d’explosion. 

warning_battery-unattended = Ne laissez pas le produit sans surveillance durant la recharge.
warning_battery-psu = Ne rechargez le produit qu’à l’aide d’une source d’alimentation électrique externe de 5 V à courant continu.
