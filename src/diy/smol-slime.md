...
| SuperMini nRF52840                              | Cheapest option, but having a ceramic antenna and your trackers also having a ceramic antenna will reduce signal strength and range.                                                                                                                                                                                                                                                                                      | Has no inbuilt antenna. To use as a receiver better to solder to it 30 cm solid core wire, as an antenna.                      |
| Seeed Studio XIAO nRF52840                      | Expensive option, but smaller.                                                                                                                                                                                                                                                                                                                                                                                            | Has no inbuilt antenna. To use as a receiver better to solder to it 30 cm solid core wire, as an antenna.                      |
### 🏃 Tracker
