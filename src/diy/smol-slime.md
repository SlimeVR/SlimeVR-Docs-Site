...
Signal strength can be improved by adding a 31c  wire to the antenna when used as a receiver. The stock antenna performs poorly on its own for a receiver.                  |
| Seeed Studio XIAO nRF52840                      | Expensive option, but smaller.                                                                                                                                                                                                                                                                                                                                                                                            |
Signal strength can be improved by adding a 31cm wire to the antenna when used as a receiver. The stock antenna performs poorly on its own for a receiver.                    |
|                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                           |                                                                                                                                             |
