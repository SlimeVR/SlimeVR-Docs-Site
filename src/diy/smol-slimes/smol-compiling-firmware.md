...
1. Download Bootloader HEX File for your device (SuperMini - <a href="http://cdn.shinebright.dev/slimenrf_promicro_bootloader-0.9.2-SlimeVR.3_s140_6.1.1.hex" target="_blank">slimenrf_promicro_bootloader-0.9.2-SlimeVR.3_s140_6.1.1.hex</a>, XIAO - ```xiao_nrf52840_ble_sense_bootloader-x.x.x_sxxx_x.x.x.hex```): <a href="https://github.com/adafruit/Adafruit_nRF52_Bootloader/releases">https://github.com/adafruit/Adafruit_nRF52_Bootloader/releases</a>
