...
1. Press the build button at the bottom of Visual Studio Code. <img class="small-size-image" alt="The build button, it looks like a tick" src="../assets/img/tick.png" />

## 3. Upload Your Firmware

* If you are using the OTA method, first make sure the tracker you wish to flash is turned on.

* Once the firmware has been built, press the upload button to upload the firmware. <img class="small-size-image" alt="The right arrow that indicates Upload" src="../assets/img/arrow.png" />
...
1. Press the upload button to upload the firmware. <img class="small-size-image" alt="The right arrow that indicates Upload" src="../assets/img/arrow.png" />
